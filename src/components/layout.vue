<template>
  <div>
    ...
    <my-dialog :isShow="isShowRegistDialog" @on-close="closeDialog('isShowRegistDialog')">
      <regist-form @close="closeDialog('isShowRegistDialog')"></regist-form>
    </my-dialog>
    <my-dialog :isShow="isShowLoginDialg" @on-close="closeDialog('isShowLoginDialg')">
